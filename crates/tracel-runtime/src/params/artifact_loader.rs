...
use tracel_artifact::bundle::BundleDecode;
use tracel_experiment::{ExperimentId, ExperimentRun, error::ExperimentError};

/// Artifact loader for loading artifacts. It allow to fecth for instance other
...
/// slug format (e.g. "my-team")), project name and an [ExperimentRun]. However, it
/// is also possible to request it directly in your routine by using declaring the param like so:
///
/// ```ignore
/// # use tracel_runtime::ArtifactLoader;
/// # use tracel_artifact::bundle::BundleDecode;
/// # use tracel::register;
/// # use tracel_runtime::Model;
/// # use serde::*;
