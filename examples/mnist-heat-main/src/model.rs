...
use crate::model::api::{HashedAssociatedType, TrainGroup, TrainableModule};
...
mod tests {
    ...
    use crate::model::api::{HashedAssociatedType, TrainGroup};
    use crate::model::{Model};

    type TG = <Model<Autodiff<Wgpu>> as HashedAssociatedType<0>>::AssociatedType;
    #[test]
    fn test_model_train_group() {
        let group = <Model<Autodiff<Wgpu>> as HashedAssociatedType<0>>::AssociatedType::new();
        let a = <Model<Autodiff<Wgpu>> as HashedAssociatedType<0>>::AssociatedType::HACK;
...
impl<B: AutodiffBackend> TrainableModule<B> for Model<B> {
    ...
    fn call_train_fn(
        ...
        <Model<B> as HashedAssociatedType<0>>::AssociatedType::new().call_train_fn(name, ctx)
    }
}
...
impl<B: AutodiffBackend> HashedAssociatedType<0> for Model<B> {
    type AssociatedType = ModelTrainGroup<B>;
}
...
mod test {
    ...
    mod train_group_impl {
        ...
        impl<B: AutodiffBackend> TrainGroup<B> for <Model<B> as HashedAssociatedType<0>>::AssociatedType {
        ...
        Self: TrainableModule<B>,
    {
        ...
        pub fn train1(
            ...
            _ = <<Model<B> as HashedAssociatedType<0>>::AssociatedType>::HACK;
